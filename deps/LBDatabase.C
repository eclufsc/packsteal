...
void _loadbalancerInit()
{
  ...
  _lb_args.neighbors_count() = CmiGetArgIntDesc(argv, "+LBNeighbors", "Using user-provided Neighbor count");
  _lb_args.lbpacksize() = CmiGetArgDoubleDesc(argv, "+LBPackSize", "Using user-provided packsize in %");
